...
from urllib.request import urlopen as uReq  # perform function same as import requests
import pymongo

app = Flask(__name__)  # creating and initialising the flask app with the name 'app'




@app.route('/',methods=['POST','GET']) # route with allowed methods as POST, GET,  PUT and DELETE
def index():                           # each function required individual routein application
...
if __name__ == "__main__":       # main part of program are belong to this section
    app.run(port=8000,debug=True) # running the app on the local machine on port 8000
                                  # debug = true help to show all error and success message in console of pycharm